...
<body>
	...
	<div id="wrapper">
		...
		<!-- 세션값이 있으면 로그아웃/개인정보수정 --> <!-- 세션값이 없으면 로그인 --> <%
 		if (member == null) {
 		%> <a href="#menu">로그인</a> <%
		} else {
		%> <a href="?">로그아웃</a>
		...
		%> <!-- 로그인 된 상태에서 클릭할 수 있는 '로그아웃' '개인정보수정' a태그 --> </nav> </header>
		...
		<ul class="actions vertical">
			<li><h5>회원가입</h5></li>
			<form action="join.do">
				<li><input id="inputId" type="text" placeholder="Email을 입력하세요"
					name="id"></li>
		...
		<div class="inner">
			...
			</c:choose> <!-- 로그인 후 로그인 한 사용자의 세션아이디로 바꾸시오.
